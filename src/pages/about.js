    ...
    <Layout pageTitle="About">
      ...
      <article class="post page post-full">
        ...
        <div class="post-content inner-sm">
          ...
          앞으로 인공지능은 보다 더 낮은 비용과 빠름을 무기로,<br />
          인간의 아날로그 세상을 빠르게 바꿔 나갈겁니다.<br />
          </p>

          <p>그리고, 인공지능 만능시대가 시작되는 이 시점에,<br />
          그동안 고심하던 여러 고민들의 해결방법을 알아버렸습니다.<br />
          단지 모니터 앞에서 조금만 벗어나면, 아날로그의 세상으로 돌아갈 수 있다는 것을...<br />          
          </p>
